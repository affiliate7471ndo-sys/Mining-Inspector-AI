...
                # --- PDF HALAMAN 2: LAMPIRAN VISUAL (GRID FOTO) ---
                ...
                img_width = 70  # Diperkecil dari 90 agar tidak menabrak batas bawah
                x_margin = 30   # Margin kiri agar gambar lebih ke tengah halaman
                x_spacing = 10  # Jarak horizontal antar foto
                y_spacing = 105 # Jarak vertikal antar baris foto
                ...
                for idx, file in enumerate(files_to_process):
                    ...
                    if idx > 0 and idx % 2 == 0:
                        y_pos += y_spacing # Turun ke baris baru
                        x_pos = x_margin
                    
                    try:
                        # Mencetak gambar dengan lebar yang sudah disesuaikan
                        pdf.image(tmp_path, x=x_pos, y=y_pos, w=img_width)
                    except:
                    ...
                    x_pos += (img_width + x_spacing)
                
                # Jeda dan paku Digital Stamp di bagian bawah halaman secara absolut
                # -30 berarti 30mm dari ujung paling bawah kertas, sehingga MUSTAHIL tertabrak gambar
                pdf.set_y(-30)
                ...
                # Digital Stamp (Diperkecil dan dibuat lebih elegan)
                pdf.set_font("Arial", "B", 6)
                pdf.set_text_color(100, 100, 100) # Warna abu-abu agar lebih "good looking"
